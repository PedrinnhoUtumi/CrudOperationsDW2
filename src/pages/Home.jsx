    ...
    return (
        <Pagina>
            <div className="flex flex-row justify-evenly gap-2 h-screen w-full bg-cinzaClaro">
                <span className="w-64 h-40 flex flex-col mt-12 items-start rounded-xl bg-blue-100">
                ...
                <span className="w-64 h-40 flex flex-col mt-12 items-start rounded-xl bg-green-100">
