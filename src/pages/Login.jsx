    ...
    return (
        <div className=" w-screen h-screen bg-orange-400 flex flex-col justify-center items-center">
            <form action="get" className="bg-white w-80 h-1/2 flex flex-col justify-around items-center rounded-2xl">
                <div className="p-4 m-1 flex flex-col justify-around items-center">
                    <label htmlFor="" className="mr-36">Usuário</label>
                    ...
                    <button className="bg-red-500 p-3 rounded-md text-white">CLIQUE AQUI</button>

                    <p className="mt-10">Não tenho conta. <a href="Cadastro.jsx" className="mt-1 text-orange-400">Cadastrar agora</a></p>
                </div>
            </form>
        </div>
    )
